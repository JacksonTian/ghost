...
var Ghost = function (browser, url, opts) {
  this.queue = [];
  this.setPage(browser, url, opts);
  this.started = false;
};
...
Ghost.prototype.setPage = function (browser, url, opts) {
  var page = new Page(browser, opts);
  page.url(url);
