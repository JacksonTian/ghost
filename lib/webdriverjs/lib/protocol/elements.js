exports.command = function (using, value, callback) {
  ...
  if (!using.match(check)) {
    throw new Error("Please provide any of the following using strings as the first parameter: class name, css selector, id, name, link text, partial link text, tag name or xpath");
  }
