exports.command = function (doWhat, callback) {
  ...
  if (doWhat.toLowerCase() === "get") {
    ...
    request = this.createRequest(commandOptionsDelete, function () {
    ...
    throw new Error("The session command need either a 'delete' or 'get' attribute to know what to do. example: client.session('get', callback) to get the capabilities of the session.");
  }
};
